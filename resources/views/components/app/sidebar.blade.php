    ...
    <div id="sidebar"
        ...
        <div class="flex justify-between mb-10 pr-3 sm:px-2">
            ...
            <a class="block" href="{{ route('dashboard') }}">
                <img class="mt-4" width="48" height="48" viewBox="0 0 56 56" src={{ asset('images/lgo.png') }}>
            </a>
        </div>
                            ...
                            <ul class="pl-9 mt-1 " :class="open ? '!block' : 'hidden'">
                                <li class="mb-1 last:mb-0">
                                    <a class="block text-slate-400 hover:text-slate-200 transition duration-150 truncate "
                                        href="/batch_list">
                                        <span
                                            class="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Training
                                            List</span>
                                    </a>
                                </li>
                                <li class="mb-1 last:mb-0">
                                ...
                                <li class="mb-1 last:mb-0">
                                    <a class="block text-slate-400 hover:text-slate-200 transition duration-150 truncate "
                                        href="/partc_list">
                                        <span
                                            class="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Ahli
                                            K3 Umum</span>
                                    </a>
                                </li>
                                <li class="mb-1 last:mb-0">
                                ...
                                <li class="mb-1 last:mb-0">
                                    <a class="block text-slate-400 hover:text-slate-200 transition duration-150 truncate "
                                        href="/partcp_list">
                                        <span
                                            class="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Peserta
                                            Pelatihan
                                            PAPA</span>
                                    </a>
                                </li>
