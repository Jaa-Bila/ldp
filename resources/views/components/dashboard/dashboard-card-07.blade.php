<div class="col-span-full xl:col-span-6 bg-white shadow-lg rounded-sm border border-slate-200">
    <header class="px-5 py-4 border-b border-slate-100">
        <h2 class="font-semibold text-slate-800">Top Company</h2>
    </header>
    <div class="p-3">
            ...
            <table class="table-auto w-full">
                ...
                <thead class="text-xs uppercase text-slate-400 bg-slate-50 rounded-sm">
                    <tr>
                        ...
                        <th class="p-2">
                            <div class="font-semibold text-center">Participant</div>
                        </th>
                        <th class="p-2">
                            <div class="font-semibold text-center">Training Batch</div>
                        </th>
                    </tr>
                </thead>
                <!-- Table body -->
                    ...
                    <tr>
                        <td class="p-2">
                            <div class="flex items-center">
                                ...
                                <div class="text-slate-800">PT. Kartika Jaya</div>
                            </div>
                        </td>
                        <td class="p-2">
                    ...
                    <tr>
                        <td class="p-2">
                            <div class="flex items-center">
                                ...
                                <div class="text-slate-800">PT. Jaya Abadi</div>
                            </div>
                        </td>
                        <td class="p-2">
                    ...
                    <tr>
                        <td class="p-2">
                            <div class="flex items-center">
                                ...
                                <div class="text-slate-800">Pt. Samkuli</div>
                            </div>
                        </td>
                        <td class="p-2">
                    ...
                    <tr>
                        <td class="p-2">
                            <div class="flex items-center">
                                ...
                                <div class="text-slate-800">PT. Bima Jaya</div>
                            </div>
                        </td>
                        <td class="p-2">
                    ...
                    <tr>
                        <td class="p-2">
                            <div class="flex items-center">
                                ...
                                <div class="text-slate-800">PT. Saudara Senja</div>
                            </div>
                        </td>
                        <td class="p-2">
