...
<div class="col-span-full xl:col-span-6 bg-white shadow-lg rounded-sm border border-slate-200">
    <header class="px-5 py-4 border-b border-slate-100">
        <h2 class="font-semibold text-slate-800">Batch K3 Umum</h2>
    </header>
    <div class="p-3">
                ...
                <tbody class="text-sm font-medium divide-y divide-slate-100 content-center">
                    ...
                    <tr>
                        <td class="p-2 flex justify-center">
                            <div class="text-slate-800 font-bold">Nama Batch</div>
                        </td>
                        <td class="p-2 flex justify-center">
                            <div class="text-slate-800">{{ $batch->name }}</div>
                        </td>
                    </tr>
                    <!-- Row -->
                    <tr>
                        <td class="p-2 flex justify-center">
                            <div class="text-slate-800 font-bold">Ahli K3 Umum</div>
                        </td>
                        <td class="p-2 flex justify-center">
                            <div class="text-slate-800">{{ $partcs->where('id_batch', $batch->id)->count() }}</div>
                        </td>
                    </tr>
                    <!-- Row -->
                    <tr>
                        <td class="p-2 flex justify-center">
                            <div class="text-slate-800 font-bold">Ahli K3 Umum Refresh</div>
                        </td>
                        <td class="p-2 flex justify-center">
                            <div class="text-slate-800">{{ $partcrs->where('id_batch', $batch->id)->count() }}</div>
                        </td>
                    </tr>
                </tbody>
            </table>
