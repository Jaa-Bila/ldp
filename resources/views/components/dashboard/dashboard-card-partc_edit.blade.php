<div>
    {!! Form::open([
        'action' => ['App\Http\Controllers\PartcController@partc_update', $partc->id],
        'method' => 'POST',
                        ...
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <div class="flex">
                                    ...
                                    {{ Form::text('itn_addr', $partc->itn_addr, ['class' => 'mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm', 'placeholder' => 'Alamat Instansi']) }}
                                </div>
                            </div>
