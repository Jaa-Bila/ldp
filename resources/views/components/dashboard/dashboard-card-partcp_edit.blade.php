<div>
    {!! Form::open([
        'action' => ['App\Http\Controllers\PartcpController@partcp_update', $partcp->id],
        'method' => 'POST',
        ...
        <div class="md:grid md:grid-cols-3 md:gap-6">
            ...
            <div class="md:col-span-1">
                <div class="px-4 sm:px-0">
                    ...
                    <p class="mt-1 text-sm text-gray-600">Data diri peserta pelatihan PAPA</p>
                </div>
            </div>
                    ...
                    <div class="bg-white px-4 py-5 sm:p-6">
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                {{ Form::text('name', $partcp->name, ['class' => 'mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm']) }}
                            </div>

                            <div class="col-span-6 sm:col-span-3">
                                {{ Form::label('ttl', 'Tempat, Tanggal Lahir', ['class' => 'block text-sm font-medium text-gray-700']) }}
                                {{ Form::text('ttl', $partcp->ttl, ['class' => 'mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm']) }}
                            </div>

                            <div class="col-span-6 sm:col-span-3">
                                {{ Form::label('jk', 'Jenis Kelamin', ['class' => 'block text-sm font-medium text-gray-700']) }}
                                {{ Form::text('jk', $partcp->jk, ['class' => 'mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm']) }}
                            </div>

                            <div class="col-span-6 sm:col-span-3">
                                {{ Form::label('nik', 'Nomor Induk Kependudukan', ['class' => 'block text-sm font-medium text-gray-700']) }}
                                {{ Form::text('nik', $partcp->nik, ['class' => 'mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm']) }}
                            </div>
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <div class="flex">
                                    ...
                                    {{ Form::text('itn_addr', $partcp->itn_addr, ['class' => 'mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm', 'placeholder' => 'Alamat Instansi']) }}
                                </div>
                            </div>

                            <div class="col-span-6 sm:col-span-3">
                                {{ Form::label('notel', 'Nomor Telepon / WA', ['class' => 'block text-sm font-medium text-gray-700']) }}
                                {{ Form::text('notel', $partcp->notel, ['class' => 'mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm']) }}
                            </div>

                            <div class="col-span-6 sm:col-span-3">
                                {{ Form::label('addr', 'Alamat kirim paket', ['class' => 'block text-sm font-medium text-gray-700']) }}
                                {{ Form::text('addr', $partcp->addr, ['class' => 'mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm']) }}
                            </div>
    ...
    <div class="bg-gray-50 px-4 py-3 text-right sm:px-6">
        {{ form::submit('Update', ['class' => 'py-2 px-3 mr-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700', 'name' => 'batch_input']) }}
    </div>
