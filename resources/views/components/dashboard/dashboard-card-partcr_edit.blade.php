<div>
    {!! Form::open([
        'action' => ['App\Http\Controllers\PartcrController@partcr_update', $partcr->id],
        'method' => 'POST',
                    ...
                    <div class="bg-white px-4 py-5 sm:p-6">
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                {{ Form::text('name', $partcr->name, ['class' => 'mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm']) }}
                            </div>

                            <div class="col-span-6 sm:col-span-3">
                                {{ Form::label('ttl', 'Tempat, Tanggal Lahir', ['class' => 'block text-sm font-medium text-gray-700']) }}
                                {{ Form::text('ttl', $partcr->ttl, ['class' => 'mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm']) }}
                            </div>

                            <div class="col-span-6 sm:col-span-3">
                                {{ Form::label('nik', 'Nomor Induk Kependudukan', ['class' => 'block text-sm font-medium text-gray-700']) }}
                                {{ Form::text('nik', $partcr->nik, ['class' => 'mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm']) }}
                            </div>
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <div class="flex">
                                    ...
                                    {{ Form::text('itn_addr', $partcr->itn_addr, ['class' => 'mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm', 'placeholder' => 'Alamat Instansi']) }}
                                </div>
                            </div>

                            <div class="col-span-6 sm:col-span-3">
                                {{ Form::label('notel', 'Nomor Telepon / WA', ['class' => 'block text-sm font-medium text-gray-700']) }}
                                {{ Form::text('notel', $partcr->notel, ['class' => 'mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm']) }}
                            </div>

                            <div class="col-span-6 sm:col-span-3">
                                {{ Form::label('email', 'E-Mail', ['class' => 'block text-sm font-medium text-gray-700']) }}
                                {{ Form::text('email', $partcr->email, ['class' => 'mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm']) }}
                            </div>
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                {{ Form::text('addr', $partcr->addr, ['class' => 'mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm']) }}
                            </div>
