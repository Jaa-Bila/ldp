...
<div class="col-span-full xl:col-span-6 bg-white shadow-lg rounded-sm border border-slate-200">
    <header class="px-5 py-4 border-b border-slate-100">
        <h2 class="font-semibold text-slate-800">Batch PAPA</h2>
    </header>
    <div class="p-3">
            ...
            <table class="table-auto w-full justify-center">
                ...
                <tbody class="text-sm font-medium divide-y divide-slate-100 content-center">
                    ...
                    <tr>
                        ...
                        <td class="p-2 flex justify-center">
                            <div class="text-slate-800">{{ $pbatch->name }}</div>
                        </td>
                    </tr>
                    <!-- Row -->
                    <tr>
                        <td class="p-2 flex justify-center">
                            <div class="text-slate-800 font-bold">Ahli PAPA</div>
                        </td>
                        <td class="p-2 flex justify-center">
                            <div class="text-slate-800">{{ $partcps->where('id_batch', $pbatch->id)->count() }}</div>
                        </td>
                    </tr>
                </tbody>
            </table>
