...
<div class="overflow-x-auto relative shadow-md sm:rounded-lg">
                                    ...
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <div class="p-6 text-center">
                                            ...
                                            <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Yakin
                                                menghapus data dari {{ $itn->name }} ?</h3>
                                            <a href="/itn_delete/{{ $itn->id }}"
                                                class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                                                Yes, I'm sure
                                            </a>
                                            <button data-modal-toggle="popup-itn{{ $itn->id }}" type="button"
    ...
    {{ $itns->links('pagination::tailwind') }}
</div>
