...
@elseif (Session::has('partcr_update'))
    <div id="alert-border-3" class="flex p-4 mb-4 bg-green-100 border-t-4 border-green-500 dark:bg-green-200"
        role="alert">
        <svg class="flex-shrink-0 w-5 h-5 text-green-700" fill="currentColor" viewBox="0 0 20 20"
            xmlns="http://www.w3.org/2000/svg">
...
<div class="overflow-x-auto relative shadow-md sm:rounded-lg">
    <div class="pb-4 pt-4 bg-white dark:bg-gray-900">
        ...
        <div class="relative mt-1">
            <div class="flex absolute ml-4 inset-y-0 left-0 items-center pl-3 pointer-events-none">
            ...
            @if (count($partcrs) > 0)
                @foreach ($partcrs as $partcr)
                    <tr
                        ...
                        <td class="py-4 px-1 wrap-content">
                            {{ $partcr->addr }}
                        </td>
                        <td class="py-4 px-6 flex flex-row">
                            ...
                            <a href="/partcr_print/{{ $partcr->id }}"
                                class="text-white bg-gradient-to-r from-teal-400 via-teal-500 to-teal-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-teal-300 dark:focus:ring-teal-800 shadow-lg shadow-teal-500/50 dark:shadow-lg dark:shadow-teal-800/80 font-medium rounded-lg text-xs px-1.5 py-1 text-center mr-2 ">Suket</a>
    ...
    {{ $partcrs->links('pagination::tailwind') }}
</div>
